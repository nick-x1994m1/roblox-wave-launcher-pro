#!/usr/bin/env python3
"""Roblox-wave-launcher screen analysis tool with overlay and hotkeys."""
import argparse
import logging
import threading
import time
...
class Robloxwavelauncherpro:
 ...
 def start(self):
 log.info("roblox-wave-launcher-pro starting...")
 ...
 self.overlay.close()
 self.hotkeys.stop()
 log.info("roblox-wave-launcher-pro stopped")
...
def main():
 ...
 app = Robloxwavelauncherpro(args.config)
 app.start()
